            ...
            <div className="space-y-10">
              {user ? (
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-base text-zinc-400">
                          Signed in with <span className="text-white">{user.email}</span>. You can
                ...
                <WorkOSEntryCard
                  ...
                  mode="register"
                  subtitle="Start with WorkOS AuthKit, then come right back here to finish your event application."
                  title="Sign up"
                />
              )}
