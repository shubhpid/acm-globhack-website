...
const venueDetails = [
  ...
  { href: "https://maps.app.goo.gl/c411Svv7Ce9MX4Sq8", icon: MapPin, label: "Location Day #2", value: "Arizona State University, Tempe Campus, ECG 150", gradient: "from-pink-500 to-rose-600", glowColor: "rgba(236, 72, 153, 0.3)", underline: true },
                ...
                {venueDetails.map((detail, index) => (
                  <div key={index} className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href={detail.href} className={` ${detail.underline ? "hover:underline hover:text-blue-300" : ""} text-foreground font-medium`}>
                        {detail.value}
                      </a>
                    </div>
                  </div>
