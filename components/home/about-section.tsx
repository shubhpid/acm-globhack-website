      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-20 px-2">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed text-balance">
            <span className="mr-1 font-zen-dots bg-gradient-to-r from-[#df2a1d] to-cyan-400 bg-clip-text text-transparent">Globehack</span>   2026 is Arizona&apos;s premier go-to-market hackathon where innovation meets implementation. 
